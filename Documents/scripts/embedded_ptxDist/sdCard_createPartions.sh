...
then
    ...
    then
        ...
        then
            ...
            SIZE_PARTION_ROOTFS="119MB"
            SIZE_PARTION_APP_DATA="64MB"
            SIZE_PARTION_LOG="2MB"
            ...
            sudo mkfs.vfat -F 12 -s 8 -S 512 -c -n "boot" ${DRIVE}1
            #mke2fs -j -I 128 -i 1024 -b 1024 -T small -L "rootfs" ${DRIVE}2
            sudo mke2fs -j -t ext4 -T small -L "rootfs" ${DRIVE}2
            #mke2fs -j -t vfat -T small -L "data" ${DRIVE}3
            #mke2fs -j -t vfat -T small -L "log" ${DRIVE}4
            sudo mkfs.vfat -c -n "data" ${DRIVE}3
            sudo mkfs.vfat -c -n "log" ${DRIVE}4
