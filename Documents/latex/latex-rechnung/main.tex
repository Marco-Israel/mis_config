...
\usepackage{rechnung}
\renewcommand*\textPreis{Netto/Einheit}
\renewcommand*\textAnzahl{Einheiten}
...
\setkomavar{yourmail}{08. Feb. 2021 } 	% Ihr Schreiben vom
\setkomavar{myref}{0002102357}       	% Unser Zeichen
...
\setkomavar*{yourmail}{Ihre Bestellung vom:} 	% Ihr Schreiben vom
\setkomavar*{myref}{Unsere Lieferanten Nr:}       	% Unser Zeichen
\setkomavar*{customer}{Ihre Kundennummer:}
...
\setkomavar{subject}{Rechnung zu Ihrer Bestellung mit Nr. 4500020358}
\setkomavar{location}{
...
\begin{document}
  ...
  \customerZIP \space \customerCity}
    ...
    \invoiceText
      \newline
	  \begin{invoice}{19}
      \Fee{Dienstleistung Entwicklung reduziert }{90.00}{288}
          \Fee{Dienstleistung Entwicklung }{100.00}{204}
          \Fee{Reisekosten DB Klasse 2 mit BahnCard 25}{103.30}{1}
          \Fee{Probe BahnCard 25}{17.90}{1}
  	  \end{invoice}
      \newline
